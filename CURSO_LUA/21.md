...
### Trabalhando com Corrotinas na C API
...
**Visão Geral da C API:**

-   A pilha virtual como mecanismo central de comunicação
-   Índices positivos e negativos
-   Tratamento de erros e ambientes protegidos
-   Estados Lua e suas características

**Estendendo sua Aplicação:**

-   Uso de Lua como linguagem de configuração
-   Execução de código Lua a partir de strings
-   Chamada de funções Lua desde C
-   Integração entre C e Lua

**Chamando Funções C:**

-   Anatomia de funções C para Lua
-   Registro de funções e bibliotecas
-   Convenções de chamada e retorno
-   Criação de bibliotecas completas

**Técnicas para Escrever Funções C:**

-   Validação robusta de argumentos
-   Manipulação eficiente de tabelas
-   Trabalho com strings e buffers
-   Boas práticas de programação

**Dados do Usuário:**

-   Full userdata para objetos complexos
-   Light userdata para ponteiros simples
...
-   Sistema de registry
-   Referências para valores Lua
-   Upvalues e closures em C
-   Callbacks e estado persistente
